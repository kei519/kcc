...
int main() {
    ...
    assert(3, ({ int foo=3; foo; }), "foo = 3; foo;");
    ...
    assert(4, ({ int x[3]; *x=3; x[1]=4; x[2]=5; *(x+1); }), "int x[3]; *x=3; x[1]=4; x[2]=5; x[1];");
    assert(5, ({ int x[3]; *x=3; x[1]=4; x[2]=5; *(x+2); }), "int x[3]; *x=3; x[1]=4; x[2]=5; x[2];");
    assert(5, ({ int x[3]; x[0]=3; x[1]=4; 2[x]=5; x[2]; }), "int x[3]; x[0]=3; x[1]=4; 2[x]=5; x[2];");

    assert(0, ({ int x[2][3]; int *y=x; *y=0; x[0][0]; }), "int x[2][3]; int *y=x; *y=0; x[0][0];");
    ...
    assert(32, ({ int x[3][4]; sizeof(*x); }), "int x[3]; sizeof(*x);");
    ...
    assert(16, ({ struct t {int a; int b;}; struct t y; sizeof(y); }), "struct t {int a; int b;}; struct t x; struct t y; sizeof(y);");
